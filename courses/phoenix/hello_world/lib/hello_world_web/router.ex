defmodule HelloWorldWeb.Router do
  ...
  scope "/", HelloWorldWeb do
    ...
    get "/random_number", NumberController, :random_number
    get "/count", NumberController, :count

    get "/home", HelloWorldController, :home
    get "/about", HelloWorldController, :about
    get "/projects", HelloWorldController, :projects
  end
